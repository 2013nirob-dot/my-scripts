(function () {
  ...
  if (typeof window.NIROB_BOOKMARK_LOAD !== "undefined") {
    const raw = window.NIROB_BOOKMARK_LOAD;
  ...
  const DEFAULT_USER_DATA = {
    id: 0,
    name: "NIROB OFFICIAL BYPASS",
    password: "0",
    tgChannel: "t.me/ClearMind0912",
    banned: 0,
    creator: "@ClearMind0912",
    chatId: "",
    createdAt: ""
  };
  ...
  async function fetchUserData() {
    DBG.log('USERS', 'Using default user data (fetch disabled).');
